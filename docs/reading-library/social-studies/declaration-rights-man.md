...
**Author:** National Constituent Assembly of France (principal drafters: Lafayette, Sieyès)
...
*Full text — public domain. Adopted by the National Constituent Assembly of France, August 26, 1789.*
...
- [R.9](../../standards/ela/gr9-10-scales.md#9-10r9) — Students can compare this document directly with the U.S. Declaration of Independence, analyzing how two documents with similar arguments structure their claims differently for different audiences and political contexts.
- [R.7](../../standards/ela/gr9-10-scales.md#9-10r7) — The phrase "liberty, property, security, and resistance to oppression" vs. Jefferson's "life, liberty, and pursuit of happiness" — close reading of word choice reveals political philosophy differences.
- [W.4](../../standards/ela/writing-standards.md#9-10w4) — Argumentative writing prompt: "Which declaration — American or French — more fully embodied Enlightenment ideals?"

---

## Social Studies Standards This Connects To

- [WH.6_12.4](../../standards/social-studies/world-history/era-3-revolutions.md#wh6-124) — The Declaration is a founding document of the French Revolution. It represents the most direct application of Enlightenment natural rights philosophy to political action in European history.
- [WH.6_12.3](../../standards/social-studies/world-history/era-3-revolutions.md#wh6-123) — Article 3 ("The principle of all sovereignty resides essentially in the nation") directly redefines political legitimacy from divine right to popular sovereignty — a fundamental shift in how political systems justify themselves.
...
| Term | Definition |
|------|-----------|
| Natural rights | Rights that all humans have by nature, regardless of government — life, liberty, property |
...
Article 3 ends divine right monarchy as a legitimate political theory. Article 4 defines liberty as bounded by others' liberty — the classic liberal political framework that still underlies modern democratic theory.

---

## Studio Ideas

1. **"From Versailles to Revolution"** — EQ: What ideas are powerful enough to topple a monarchy? · Standard: WH.6_12.4 + Era 3 · Demo Mode: Written Assessment (analyze how the Declaration's ideas caused the French Revolution to radicalize)

2. **"Liberty, Property, or Security — What Matters Most?"** — EQ: If rights conflict, which takes priority? · Standard: WH.6_12.3 + Era 3 · Demo Mode: Verbal Conversation (structured debate using the Declaration's article framework)

3. **"Two Declarations, Two Revolutions"** — EQ: Why did the French Revolution end so differently from the American Revolution? · Standard: WH.6_12.4 + Era 3, R.9 (ELA) · Demo Mode: Extended Writing (W.4 comparative argument using both documents as primary sources)
...
- [Communist Manifesto Selections](/reading-library/social-studies/communist-manifesto-selections.md)
