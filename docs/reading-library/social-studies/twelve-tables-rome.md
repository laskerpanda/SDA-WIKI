...
**Author:** The Decemviri (a Roman commission of ten men)
**Type:** Primary Source · Legal Document
...
### Table IV — Concerning the Rights of Fathers (Patria Potestas)
...
### Table V — Concerning Inheritance and Guardianship
...
### Table VI — Concerning Acquisition and Possession
...
### Table VII — Concerning Land Rights
...
### Table VIII — Concerning Torts and Delicts (Injuries)
...
>
> *(Note: This prohibition was abolished shortly after the Tables were published, by the Lex Canuleia of 445 BCE — one of the earliest examples of a Roman law being successfully challenged by popular protest.)*
...
- [R.9](../../standards/ela/gr9-10-scales.md#9-10r9) — The Twelve Tables are a structured legal argument: each provision states a rule and implies the reasoning behind it. Students analyze what each law reveals about Roman values and what problems it was trying to solve.
- [R.7](../../standards/ela/gr9-10-scales.md#9-10r7) — The terse, declarative style ("If anyone… he shall…") is a deliberate legal register. Compare to the narrative style of the Egyptian Book of the Dead or the philosophical verse of the Dhammapada — three different ways of encoding moral rules.

---

## Social Studies Standards This Connects To

- [WH.6_12.2](../../standards/social-studies/world-history/era-1-civilizations.md#wh6-122) — The Tables reveal Roman values: family authority (patria potestas), property rights, the sacred obligation to honor the dead, the horror of treason. What Rome believed shows in what Rome punished.
- [WH.6_12.3](../../standards/social-studies/world-history/era-1-civilizations.md#wh6-123) — The Twelve Tables are the foundation of Roman law — and Roman law is the foundation of most Western legal systems today. They established the principle that laws must be written and public. The demand for written laws by plebeians is one of the first examples of citizens using political pressure to limit the power of an aristocracy.
- [WH.6_12.4](../../standards/social-studies/world-history/era-1-civilizations.md#wh6-124) — Tables III (debt slavery) and IV (patria potestas) reveal the economic and social structure of early Rome: extreme inequality between creditors and debtors, near-absolute power of fathers over families, and legal distinctions between free citizens, freed persons, and slaves.
...
| Term | Definition |
|------|-----------|
| Patrician | A member of the Roman aristocracy — the class that originally controlled law, politics, and religion |
| Plebeian | A common citizen of Rome — the class that demanded the Twelve Tables so they could know the laws that governed them |
| Decemviri | The committee of ten men appointed to write the Twelve Tables |
| Patria potestas | "Power of the father" — the legal authority of a Roman father over his entire household, including the power of life and death over his children |
...
This law reveals both the extreme power of Roman fathers (they could legally sell their sons into slavery) and a limit on that power — the son could be freed after three sales. It shows a legal system still treating people as property while beginning to recognize limits on that treatment.

---

## Studio Ideas

1. **"Who Did Roman Law Protect?"** — EQ: When a law is written down, who benefits? · Standard: WH.6_12.3 + WH.6_12.4 · Demo Mode: Written Assessment (read Tables III, IV, and VIII carefully. Who is protected by these laws? Who is not? Write a W.4 argument: were the Twelve Tables a step toward justice, or a codification of inequality?)

2. **"Three Legal Codes"** — EQ: What does a civilization's law reveal about its values? · Standard: WH.6_12.3 · Demo Mode: Visual/Creative (create a comparison chart of Hammurabi's Code, the Twelve Tables, and one modern law — what problem does each address? What does each assume about human nature? What punishments does each allow?)

3. **"The People Demand to See the Law"** — EQ: Why does it matter whether laws are written down and public? · Standard: WH.6_12.3 · Demo Mode: Verbal Conversation (the Twelve Tables were created because plebeians demanded that laws be written down. Why? What happens when only some people know what the laws are? Can you think of modern examples where access to legal knowledge creates inequality?)
...
- [Roman Republic — Polybius](./roman-republic-polybius.md) — Analysis of how Rome's government worked in the same era
- [Pericles' Funeral Oration](./pericles-funeral-oration.md) — Greek democratic values to compare with Roman legal structure
