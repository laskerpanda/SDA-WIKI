...
**Type:** Primary Source · Argumentative Essay
**Source:** [Project Gutenberg](https://www.gutenberg.org/ebooks/3420) — public domain
**Era/Period:** Era 3 — Age of Revolutions
**WH Standards:** WH.6_12.4 · WH.6_12.3

---

## Read It

*Key selections — full text public domain. [Full text at Project Gutenberg](https://www.gutenberg.org/ebooks/3420).*
...
>
> There must be more equality established in society, or morality will never gain ground, and this virtuous equality will not rest firmly even when founded on a rock, if one half of mankind are chained to its bottom by fate, for they will be continually undermining it through ignorance or pride. It is vain to expect virtue from women till they are, in some degree, independent of men; nay, it is vain to expect that strength of natural affection, which would make them good wives and good mothers. Whilst they are absolutely dependent on their husbands, they will be cunning, mean, and selfish, and the men who can be gratified by the fawning fondness, of spaniel-like affection, have not much delicacy, for love is not to be bought, in any sense of the word, its silken wings are instantly shrivelled up when any thing beside a return in kind is sought.
>
...
>
> A truly benevolent legislator always endeavours to make it the interest of each individual to be virtuous; and thus private virtue becoming the cement of public happiness, an orderly whole is consolidated by the tendency of all the parts towards a common centre.
...
- [R.9](../../standards/ela/gr9-10-scales.md#9-10r9) — Wollstonecraft constructs a rigorous argument: Women *seem* inferior because they lack education. Education would prove they're rational equals. Therefore, denying women education is circular — it creates the inferiority it claims to observe. Students trace her logical structure.
- [R.7](../../standards/ela/gr9-10-scales.md#9-10r7) — Her tone is unusually direct and combative for a woman writing in 1792. She uses words like "degraded" and "tyranny" to describe women's social position. Close reading of word choice reveals the risks she was taking.
- [W.4](../../standards/ela/writing-standards.md#9-10w4) — Argumentative writing: "Was the Declaration of the Rights of Man truly a universal document? Use Wollstonecraft as evidence." Or: "Which did more to expand rights — the Declaration of the Rights of Man or Wollstonecraft's *Vindication*?"

---

## Social Studies Standards This Connects To

- [WH.6_12.4](../../standards/social-studies/world-history/era-3-revolutions.md#wh6-124) — *Vindication* is a revolutionary document in the literal sense — it demanded a revolution in women's legal and social status. It demonstrates that the Age of Revolutions generated radical challenges to *all* forms of traditional hierarchy, not just monarchy.
- [WH.6_12.3](../../standards/social-studies/world-history/era-3-revolutions.md#wh6-123) — Wollstonecraft directly challenges the political systems of her era (constitutional monarchy, republican government) for excluding women from citizenship. She exposes the gap between Enlightenment ideals and Enlightenment practice.
...
| Term | Definition |
|------|-----------|
| Rational | Based on reason and logic — the Enlightenment's highest value, which Wollstonecraft claims women have equally |
| Virtue | Moral excellence — Wollstonecraft argues women are taught to value beauty over virtue, which corrupts their character |
| Sensibility | Emotional sensitivity and aesthetic refinement — the "feminine" qualities Wollstonecraft critiques as substitute for rational development |
| Tyranny | Cruel and oppressive rule — Wollstonecraft applies this word, typically used for kings, to the power men hold over women |
| Subjugation | The state of being under the control or authority of another — what Wollstonecraft argues is women's current condition |
...
> — *A Vindication of the Rights of Woman*, Chapter 4

And:

> Taught from their infancy that beauty is woman's sceptre, the mind shapes itself to the body, and roaming round its gilt cage, only seeks to adorn its prison.
> — *A Vindication of the Rights of Woman*, Chapter 3

The first passage states the argument precisely: not power over others, but self-determination. The second is one of the most memorable metaphors in political writing — women's education trains them to be beautiful prisoners. Students can analyze how Wollstonecraft uses this metaphor structurally throughout the text.

---

## Studio Ideas

1. **"Who Did the Enlightenment Leave Out?"** — EQ: Can a movement for freedom also be a movement for oppression? · Standard: WH.6_12.4 + Era 3 · Demo Mode: Written Assessment (analyze the contradiction between the Declaration of the Rights of Man and Wollstonecraft's critique)

2. **"Wollstonecraft vs. Rousseau"** — EQ: Who controls what women should be? · Standard: WH.6_12.3 + Era 3 · Demo Mode: Verbal Conversation (structured discussion comparing Rousseau's *Emile* view of female education with Wollstonecraft's argument against it)

3. **"The Argument That Changed Nothing (At First)"** — EQ: Why do powerful ideas sometimes fail to produce immediate change? · Standard: WH.6_12.4 + Era 3 · Demo Mode: Extended Writing (W.4 argument: Wollstonecraft published in 1792. Women in Britain didn't get the vote until 1928. What happened in between? What does this tell us about how social change works?)
...
- [Common Sense — Paine](common-sense-paine.md)
- [Declaration of Rights of Man](declaration-rights-man.md)
